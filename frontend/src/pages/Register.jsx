...
const Register = () => {
  ...
  return (
    <div className="w-full min-h-screen bg-gradient-to-br from-black via-black to-blue-900
      flex items-center justify-center px-6 py-12 relative overflow-hidden">

      {/* animated blobs */}
      <div className="absolute w-[400px] h-[400px] bg-cyan-500/20
        rounded-full blur-3xl animate-blob top-[-10%] left-[-10%]"></div>
      <div className="absolute w-[300px] h-[300px] bg-blue-500/20
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
          ...
          <div className="relative">
            ...
            <input
              ...
              className="w-full pl-12 pr-12 py-4 bg-white/10
...
const InputField = ({ icon, placeholder, register, error, type = "text" }) => (
  <div className="relative">
    ...
    <input
      ...
      className="w-full pl-12 pr-4 py-4 bg-white/10
        border border-blue-500/30 rounded-2xl
        text-white placeholder-gray-400
        focus:ring-2 focus:ring-cyan-500 outline-none"
      {...register}
